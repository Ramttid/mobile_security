package com.example.mobile_security_project.ui.interfaces
...
fun LoginForm(){
    Surface {
        ...
        Column(
            ...
            LabeledCheckbox(label = "remember me", onCheckChanged = {credentials = credentials.copy(remember = !credentials.remember) },
